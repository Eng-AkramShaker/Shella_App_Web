...
class ApiClient {
  ...
  Map<String, String> updateHeader(
    ...
    header.addAll({
      ...
      Api_Constants.zoneId: zoneIDs != null && zoneIDs.isNotEmpty ? jsonEncode(zoneIDs) : jsonEncode([2,3,4,5]),
      Api_Constants.moduleId: moduleID != null && moduleID!= 0 ? jsonEncode(moduleID) : jsonEncode(3),
