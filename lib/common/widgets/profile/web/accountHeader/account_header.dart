    ...
    return Row(
      ...
      children: [
        IconButtonCircle(
          ...
          onPressed: () {
            controller.currentAddressesPage == 0
                ? nav.back()
                : controller.setCurrentAddressesPage(0);
        ...
        Custom_Text(
          ...
          style:
              font10Black600W(context, size: width(context, 1) > 600 ? 25 : 17),
        ),
        const Spacer(flex: 1),
            ...
            child: DropdownButton(
              hint: Padding(
                ...
                child: Custom_Text(context,
                    text: _getMainTitle(controller.currentPage),
                    style: font10Black600W(context, size: 15)),
              ),
