          ...
          SizedBox(
            ...
            child: DropdownButton(
              ...
              items: [
                ...
                DropdownMenuItem(value: 2,child: Custom_Text(context,text: 'المفضلة لديك',style: font10Black600W(context, size: 15))),
                ...
                DropdownMenuItem(value: 5,child: Custom_Text(context,text: 'محفظة قيدها',style: font10Black600W(context, size: 15))),
                ...
                DropdownMenuItem(value: 8,child: Custom_Text(context,text: 'سياسة الاسترداد',style: font10Black600W(context, size: 15))),
                DropdownMenuItem(value: 9,child: Custom_Text(context,text: 'سياسة الخصوصية',style: font10Black600W(context, size: 15))),
                DropdownMenuItem(value: 10,child: Custom_Text(context,text: 'الشروط قيدها',style: font10Black600W(context, size: 15))),
                DropdownMenuItem(value: 11,child: Custom_Text(context,text: 'الشروط والأحكام',style: font10Black600W(context, size: 15))),
                DropdownMenuItem(value: 12,child: Custom_Text(context,text: 'المساعدة والدعم',style: font10Black600W(context, size: 15))),
                DropdownMenuItem(value: 13,child: Custom_Text(context,text: 'تسجيل الخروج',style: font10Black600W(context, size: 15))),
              ],
              onChanged: (value){
