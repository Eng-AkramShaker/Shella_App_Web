  ...
  Widget build(BuildContext context) {
    return Center(
      child: Padding(
        ...
        child: SizedBox(height: size??25,width: size??25,child: CircularProgressIndicator(strokeWidth: 1.5,color: isData==true?AppColors.orangeColor:color??AppColors.bgColor,)),
      ),
    );
  }
}
