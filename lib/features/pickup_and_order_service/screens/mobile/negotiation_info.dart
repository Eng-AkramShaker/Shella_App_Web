...
class _NegotiationInfoState extends State<NegotiationInfo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: customAppBar(
          context,
          title: MainAppConstants.offerNegotiation,
          img: AppImages.percent1,
          onPressed: () {
            ...
            child: SingleChildScrollView(
              child: Align(
                ...
                child: Column(
                  ...
                  children: [
                    Custom_Text(context,
                        text: MainAppConstants.priceNegotiation,
                        style: font14Black600W(context)),
                    SizedBox(
                      height: 15.h,
                    ),
                    Custom_Text(context,
                        text: MainAppConstants.negotiationWithDriver,
                    ...
                    Center(
                      child: Custom_Text(context,
                          text: MainAppConstants.proposedPrice,
                          style: font14Grey400W(context)),
                    ),
                    SizedBox(
                      height: 15.h,
                    ...
                    Center(
                      child: Custom_Text(context,
                          text: widget.price != null
                              ...
                              : "SAR 68",
                          style: font24Primary700W(context)),
                    ),
                    SizedBox(
                      height: 25.h,
                    ),
                    Custom_Text(context,
                        text: MainAppConstants.proposeNewPrice,
                    ...
                    Column(
                      ...
                      children: [
                        StepProgressIndicator(
                          ...
                          totalSteps: 80,
                          currentStep:
                              widget.price != null ? widget.price!.toInt() : 68,
                          size: 20,
                          padding: 0,
                        ...
                        MessageShape(
                          isSender: false,
                          messageText: "يمكنني قبول 68 ريال",
                        ),
                        const SizedBox(height: 15),
                        MessageShape(
                          isSender: true,
                          messageText: "هل يمكن 60 ريال",
                        ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              PickupCustomButton(
                                ...
                                fontSize: 10,
                                onPressed: () {
                                  nav.push(AppRoutes.confirmationOrder);
                                },
                              ),
                            ],
                          ),
