            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child:
                      Container(child: Custom_Text(context, text: MainAppConstants.deliveryDetails, style: font16Black500W(context))),
                ),
                SizedBox(
                  height: 10.h,
                ),
                ...
                Center(
                  child: InkWell(
                      onTap: () {},
                      child: Custom_Text(context, text: MainAppConstants.backToMain, style: font14SecondaryColor500W(context))),
                )
              ],
            ),
          ),
