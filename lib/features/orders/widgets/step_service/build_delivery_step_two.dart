      ...
      children: [
        InkWell(
          ...
          child: Column(
            ...
            children: [
              custom_Images_asset(
                  image: AppImages.send_2, h: 47.h, w: 100.w, fit: BoxFit.none),
              Custom_Text(context,
                  text: "نقل باتجاه واحد", style: font11Black600W(context)),
            ],
          ),
        ),
        InkWell(
          ...
          child: Column(
            ...
            children: [
              custom_Images_asset(
                  image: AppImages.send_1, h: 47.h, w: 100.w, fit: BoxFit.none),
              Custom_Text(context,
                  text: "نقل باكثر من اتجاه", style: font11Black600W(context)),
            ],
          ),
        ),
      ],
