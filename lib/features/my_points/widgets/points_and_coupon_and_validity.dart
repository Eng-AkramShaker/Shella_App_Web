            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    width: ResponsiveLayout.isWeb()? 2.0 : 1,
                    color: AppColors.gryColor_6
                  )
                ),
                child: Padding(padding: EdgeInsets.all(3.sp),
                  child: Row(
                    children: [
                      SvgPicture.asset('assets/images/points.svg',width: ResponsiveLayout.isWeb()? 48.w : 20.w ,),
                      SizedBox(width: 5.w,),
                      Column(
                        ...
                        children: [
                          ...
                          Custom_Text(
                              context,
                              text: 'عرض السجل',
                              style: font8Black400W(context).copyWith(
                                  color: Color(0xFF868986)
                              )
                          ),
                        ],
                      ),
