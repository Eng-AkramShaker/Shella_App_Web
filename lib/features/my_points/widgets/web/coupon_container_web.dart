...
class CouponContainerWeb extends StatelessWidget {
  const CouponContainerWeb({
    super.key,
    required this.loyaltyProvider,
  });
  ...
  Widget build(BuildContext context) {
    if (loyaltyProvider.isLoading) return _loadingIndicator();
    return Expanded(
      child: Container(
