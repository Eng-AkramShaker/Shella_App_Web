class CartProductsModel {
  ...
  CartProductsModel({this.totalSize, this.limit, this.offset, this.items});
...
class Items {
  ...
  Items.fromJson(Map<String, dynamic> json) {
    ...
    categoryIds =
    json["category_ids"] == null ? null : (json["category_ids"] as List).map((
        e) => CategoryIds.fromJson(e)).toList();
    ...
    stock = json["stock"];
    unitId = json["unit_id"];
    images = json["images"] == null ? null : (json["images"] as List).map((e) =>
    ...
    imagesFullUrl = json["images_full_url"] == null ? null : List<dynamic>.from(
        json["images_full_url"]);
    storage =
    json["storage"] == null ? null : (json["storage"] as List).map((e) =>
        Storage.fromJson(e)).toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    if (categoryIds != null) {
      _data["category_ids"] = categoryIds?.map((e) => e.toJson()).toList();
    }
    if (variations != null) {
...
class Module {
  ...
  Module(
      {this.id, this.moduleName, this.moduleType, this.thumbnail, this.status, this.storesCount, this.createdAt, this.updatedAt, this.icon, this.themeId, this.description, this.allZoneService, this.iconFullUrl, this.thumbnailFullUrl, this.storage, this.translations});
  ...
  Module.fromJson(Map<String, dynamic> json) {
    ...
    storage =
    json["storage"] == null ? null : (json["storage"] as List).map((e) =>
        Storage1.fromJson(e)).toList();
    translations =
    json["translations"] == null ? null : (json["translations"] as List).map((
        e) => Translations1.fromJson(e)).toList();
  }
...
class Storage1 {
  ...
  Storage1(
      {this.id, this.dataType, this.dataId, this.key, this.value, this.createdAt, this.updatedAt});
...
class Unit {
  ...
  Unit.fromJson(Map<String, dynamic> json) {
    ...
    translations =
    json["translations"] == null ? null : (json["translations"] as List).map((
        e) => Translations.fromJson(e)).toList();
  }
