    ...
    return SizedBox(
      ...
      child: SearchFilterController.get(context).searchResultModel!.stores!.isEmpty
          ? Padding(
              ...
              child:
                  Center(child: Custom_Text(context, text: 'لا يوجد متاجر', style: font10Black300W(context, size: size_14(context)))),
            )
          : ListView.separated(
              shrinkWrap: true,
              ...
              itemBuilder: (context, index) => Row(
                    children: [
                      ClipRRect(
                          ...
                          child: Image.network(
                            SearchFilterController.get(context).searchResultModel!.stores![index].logoFullUrl ?? '',
                            height: 80.h,
                            width: 70.w,
                            fit: BoxFit.fill,
                      ...
                      Expanded(
                          child: Custom_Text(context,
                              text: SearchFilterController.get(context).searchResultModel!.stores![index].name ?? '',
