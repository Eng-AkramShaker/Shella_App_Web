        ...
        itemBuilder: (context, index) => MouseRegion(
              ...
              child: Container(
                decoration: BoxDecoration(
                    ...
                    border: SearchFilterController.get(context).isHover == true &&
                            SearchFilterController.get(context).containerIndex == index
                        ? Border.all(color: AppColors.greenColor)
                        : null),
                padding:
                    SearchFilterController.get(context).isHover == true && SearchFilterController.get(context).containerIndex == index
                ...
                child: Row(
                  children: [
                    ClipRRect(
                        ...
                        child: Image.network(
                          SearchFilterController.get(context).mixedList[index]['img'] ?? '',
                          height: 130.h,
                          width: 40.w,
                          fit: BoxFit.fill,
                    ...
                    Expanded(
                        child: Custom_Text(context,
                            text: SearchFilterController.get(context).mixedList[index]['name'] ?? '',
