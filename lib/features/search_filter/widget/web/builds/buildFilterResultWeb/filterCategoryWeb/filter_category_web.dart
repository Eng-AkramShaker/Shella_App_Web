    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          ListView.separated(
              shrinkWrap: true,
              itemBuilder: (context, index) => CategoryInfoWeb(
                    categoryImg: SearchFilterController.get(context).allCategoriesModel![index].image ?? '',
                    categoryName: SearchFilterController.get(context).allCategoriesModel![index].name ?? '',
                    categoryCount: SearchFilterController.get(context).allCategoriesModel![index].productsCount.toString(),
                    isSelected: index == 0,
                  ),
