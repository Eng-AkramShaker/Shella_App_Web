                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildserviceinfo(
                        ...
                        "نوع الخدمة",
                        'صيانة السباكة'),
                    _buildserviceinfo(context, Icons.home_outlined, "المنزل",
                        'السعودية , الرياض 55552333'),
                    _buildserviceinfo(context, Icons.date_range_outlined,
                        "التاريخ", '25 فبراير'),
                    _buildserviceinfo(
                        context, Icons.access_time_outlined, "الوقت", '9:00'),
                    _buildserviceinfo(
                        context,
...
Widget _buildserviceinfo(
    BuildContext context, IconData icon, String maintext, String sectext) {
  return Row(
    children: [
      ClipOval(
        child: Container(
