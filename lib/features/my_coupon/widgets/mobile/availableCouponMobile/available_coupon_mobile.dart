                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Custom_Text(context,text: discount.toString(), style: font16SecondaryColor400W(context).copyWith(color: AppColors.secondaryColor)),
                        SizedBox(
                          height: 10.h,
                        ),
                        Custom_Text(context,text: 'بدون حد ادنى', style: font12SecondaryColor400W(context).copyWith(color: AppColors.secondaryColor)),
                      ],
                    ),
                  ),
                ),
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Custom_Text(context, text: 'خصم  30% وفر حتى 20 ر.س', style: font12Black400W(context).copyWith(color:  AppColors.bgColor)),
                        SizedBox(
                          height: 10.h,
                        ),
                        Container(
