...
import 'package:shella_design/common/widgets/loading_progress/custom_button.dart';
...
class AvailableCouponMobile extends StatelessWidget {
  const AvailableCouponMobile(
      {super.key, required this.index, this.discount, this.expiredDate});
                      ...
                      child: Column(
                        ...
                        children: [
                          Custom_Text(context,
                              ...
                              style: font16SecondaryColor400W(context, size: 17)
                          ...
                          Custom_Text(context,
                              text: 'بدون حد ادنى',
                              style: font12SecondaryColor400W(context, size: 14)
                                  .copyWith(color: AppColors.secondaryColor)),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Custom_Text(context,
                              ...
                              style: font12Black400W(context, size: 10)
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Custom_Text(context,
                                  ...
                                  style:
                                      font6SecondaryColor400W(context, size: 8)
                                          .copyWith(
                          ...
                          Custom_Text(context,
                              ...
                              style: font8Black400W(context, size: 10)
                                  .copyWith(color: AppColors.bgColor)),
                          if (MyCouponController.get(context)
                                  .availableCoupons![index]
                                  .storeId !=
                              null)
                            Padding(
                              padding: EdgeInsets.only(
                                  left: 10, right: width(context, 0.35)),
                              child: CustomButton(
                                onTap: () => MyCouponController.get(context,
                                        listen: false)
                                    .applyCoupon(
                                        code: MyCouponController.get(context,
                                                listen: false)
                                            .availableCoupons![index]
                                            .code,
                                        storeId: MyCouponController.get(context,
                                                listen: false)
                                            .availableCoupons![index]
                                            .storeId),
                                height: 27,
                                ...
                                textSize: 13.sp,
                                isLoading: MyCouponController.get(context)
                                        .applyCouponState ==
                                    MyCouponState.loading,
