                      ...
                      children: [
                        Custom_Text(
                            ...
                            style: font12Black400W(context).copyWith(
                                color: coupon.isAvailable == false? AppColors.darkGreyColor:AppColors.bgColor
                            )
                        ),
                        SizedBox(height: 10.h,),
                        Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              width: 1,
                                color: coupon.isAvailable? AppColors.secondaryColor : AppColors.darkGreyColor
                            )
                          ),
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
