...
class AvailableCouponContainerWeb extends StatelessWidget {
  const AvailableCouponContainerWeb(
      {super.key, this.discount, this.expiredDate});
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Custom_Text(context,
                              text: 'بدون حد ادنى',
                              style: font12SecondaryColor400W(context, size: 12)
                                  .copyWith(color: AppColors.secondaryColor)),
                        ],
                      ),
                    ),
                            ...
                            children: [
                              Expanded(
                                  child: Custom_Text(context,
                                      ...
                                      style: font12Black400W(context, size: 14)
                                          .copyWith(color: AppColors.bgColor))),
                              Custom_Text(context,
                                  text: 'صالح حتى $expiredDate',
                                  style: font8Black400W(context, size: 12)
                                      .copyWith(color: AppColors.bgColor)),
                            ],
                          ),
                          SizedBox(
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Custom_Text(context,
                                  ...
                                  style:
                                      font6SecondaryColor400W(context, size: 10)
                                          .copyWith(
