...
class DiscountRepository implements DiscountRepositoryInterface{
  ...
  Future<http.Response?> fetchDiscountedProducts({offset}) async {
    Response? response = await ApiClient(appBaseUrl: Api_Constants.appBaseUrl,sharedPreferences: sp<SharedPreferences>()).getData(Api_Constants.discountProducts,query: {'type': 'all','offset': offset,'limit': '50'});
    return response;
  }
}
